...
public class el_PrincipalesFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        super.onCreateView(inflater,container,savedInstanceState);
        View v = inflater.inflate(R.layout.fragment_el_principales, container, false);

        List<Elemento> lista = GlobalClass.getElementosPrincipales();

        RecyclerView contenedor = (RecyclerView)v.findViewById(R.id.cont_el_principales);
